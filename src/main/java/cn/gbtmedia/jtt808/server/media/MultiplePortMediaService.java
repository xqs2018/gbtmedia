...
import cn.gbtmedia.jtt808.server.media.server.MultiplePortServer;
...
@ConditionalOnProperty(prefix = "server-config.jtt808", name = "mediaModel", havingValue = "multiple",matchIfMissing = true)
public class MultiplePortMediaService implements MediaService{

    @Override
    public MediaServer createServer(MediaParam mediaParam) {
        MediaServer mediaServer = new MultiplePortServer();
