...
public class FlvMuxerTest {
    ...
    public static void main1(String[] args) throws InterruptedException {
        ...
        flvEncoder.onFlvData(FlvMuxerTest::testflvList);
...
//        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // ffmpeg -f h264 -i test-h26433417.h264 -f alaw -ar 8000 -ac 1 -i test-g71115095.g711 -c:v copy -c:a aac -ar 44100 -ac 2 -b:a 128k -f flv -flvflags no_duration_filesize -async 1 -vsync 1 output.flv
        // 合并命令
